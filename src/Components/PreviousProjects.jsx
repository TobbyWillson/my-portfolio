              ...
              >
                ...
                <div className='flex flex-1 flex-col gap-4 p-6 pt-5'>
                  ...
                  <div className='flex flex-wrap gap-6 max-[368px]:gap-4 pt-1'>
                    ...
                    <a href={project.repoUrl} target='_blank' rel='noreferrer' className='inline-flex items-center gap-2 text-sm font-medium transition hover:border-[#2563EB]/50 hover:text-[#2563EB] dark:hover:text-[#a9bdee]'>
